...
doc_events = {
	"WB Task Extension": {
		...
		"on_update": "workboard.workboard.doctype.wb_task_extension.wb_task_extension.update_wb_task_on_extension_submit",
	},
	"Quotation": {
...
scheduler_events = {
	...
	"hourly": ["workboard.background_jobs.trigger_hourly_offset_rules"],
}
